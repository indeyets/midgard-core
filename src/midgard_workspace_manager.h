...
gboolean 		midgard_workspace_manager_create		(MidgardWorkspaceManager *self, MidgardWorkspaceStorage *ws, GError **error);
gboolean 		midgard_workspace_manager_update		(MidgardWorkspaceManager *self, MidgardWorkspaceStorage *ws, GError **error);
gboolean 		midgard_workspace_manager_delete		(MidgardWorkspaceManager *self, MidgardWorkspaceStorage *ws, GError **error);
